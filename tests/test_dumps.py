...
class DumpsTests(unittest.TestCase):
    ...
    def assertDumpsMatchesDict(self, s, d):  # noqa: N802
        pairs = [
            u'"%s"=>%s'
            % (key, (u'"%s"' % value if value is not None else u"NULL"))
    ...
    def test_values_with_quotes(self):
        ...
        self.assertEqual(
            u'"key_\\"quoted\\"_string"=>"value_\\"quoted\\"_string"',
    ...
    def test_escaped_values(self):
        ...
        self.assertEqual(
            u'"key_\\\\escaped\\\\_string"=>"value_\\\\escaped\\\\_string"',
            self.pghstore.dumps(d, return_unicode=True),
        )
    ...
    def test_large(self):
        d = {
            ...
            "name:sl": u"Norve\u0161ka",
            "name:sv": "Norge",
            "name:th": u"\u0e1b\u0e23\u0e30\u0e40\u0e17\u0e28\u0e19\u0e2d\u0e23\u0e4c\u0e40\u0e27\u0e22\u0e4c",  # noqa: E501
            "name:tr": u"Norve\xe7",
            "name:uk": u"\u041d\u043e\u0440\u0432\u0435\u0433\u0456\u044f",
            "name:vi": "Na Uy",
            "name:zh": u"\u632a\u5a01",
            ...
            "official_name:be": u"\u041a\u0430\u0440\u0430\u043b\u0435\u045e\u0441\u0442\u0432\u0430 \u041d\u0430\u0440\u0432\u0435\u0433\u0456\u044f",  # noqa: E501
            "official_name:el": u"\u0392\u03b1\u03c3\u03af\u03bb\u03b5\u03b9\u03bf \u03c4\u03b7\u03c2 \u039d\u03bf\u03c1\u03b2\u03b7\u03b3\u03af\u03b1\u03c2",  # noqa: E501
